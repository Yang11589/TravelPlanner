      ...
      <div className="w-full max-w-md bg-surface-container-lowest rounded-2xl shadow-xl overflow-hidden border border-primary/5">
        <div className="p-10">
          <div className="text-center mb-10">
            <h2 className="font-headline text-4xl font-bold text-primary mb-2">Welcome Back</h2>
            <p className="text-on-surface-variant font-body tracking-tight">Continuously curating your journey.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="mt-4 bg-primary text-on-primary py-4 rounded-lg shadow-sm font-bold hover:opacity-90 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
